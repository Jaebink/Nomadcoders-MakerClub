  ...
  return (
    ...
    >
      <motion.button
        ...
        className="flex h-9 items-center border bg-white dark:bg-[#121212] px-3 text-sm font-medium outline-none cursor-pointer"
      >
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <motion.span
              aria-hidden
              className="sr-only absolute left-4 top-[17px] text-sm text-muted-foreground data-[success]:text-transparent"
