            ...
            <div className="w-full max-w-4xl mx-auto p-8">
                ...
                <div className="bg-white rounded-lg shadow-xl p-8 mb-8">
                    <PopoverForm
                        ...
                        height="400px"
                    />                    
                    <p className="text-center text-gray-600">당신의 편지는 익명으로 랜덤한 해결사들에게 전달됩니다.</p>
                </div>
                <div className="bg-white rounded-lg shadow-xl p-8">
                    <p className="text-center text-gray-600 mb-4">사람들의 편지를 수신하고 싶다면 아래 스위치를 켜세요.</p>
                    <div className="flex justify-center mt-6">
                        <Switch
                            ...
                            className="mr-2"
                        />
                        <label htmlFor="concern-receiving" className="text-gray-600">고민 해결사 일하기</label>
                    </div>
                </div>
            </div>
            <div className="flex flex-col items-center mt-4">
                <Mailbox className="text-white size-6 " />
                {/* 알림 */}
                ...
                : <div className="bg-blue-50 p-3 rounded-lg border border-blue-200 mt-4 space-y-2">
                    <p className="text-sm text-blue-700">고민이 없습니다</p>
                </div>
                }
            </div>
        </div>
